...
<div id="content">
	...
	<div id="homepage">
            ...
            <p>Head over to the <a href="<?php bloginfo('url'); ?>/wp-admin/themes.php?page=functions.php">theme options</a> page in your dashboard to get started or take a look at the <a href="<?php bloginfo('template_directory'); ?>/readme.php">Readme</a> file included in this theme.</p>
            <p>If you feel that you are seeing this message in error, make sure that the Featured Post section in the <a href="<?php bloginfo('url'); ?>/wp-admin/themes.php?page=functions.php">Baby Sweettooth Options</a> page is entered and is set to something other than <a href="<?php bloginfo('url'); ?>/?cat=1">'Uncategorized'</a>.  (For that matter, make sure all the Featured sections are filled in.)</p>
            </div>
            <?php } ?>	
		<div id="homepagetop">
